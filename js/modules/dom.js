...
export const interiorsViewBtn = document.getElementById('interiors-view-btn');
...
export const interiorsValues = document.getElementById('interiors-values');
export const interiorsBreakouts = document.getElementById('interiors-breakouts');
export const interiorsGraph = document.getElementById('interiors-graph');
